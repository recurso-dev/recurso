...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background shadow-overlay transition ease-standard data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-normal data-[state=open]:duration-slow",
  {
    variants: {
      side: {
...
const SheetFooter = ({ className, ...props }) => (
  <div
    className={cn(
      "mt-auto flex flex-row justify-end gap-2 border-t border-border px-6 py-4",
      className
    )}
    {...props}
  />
