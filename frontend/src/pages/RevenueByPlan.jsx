...
// Emerald ramp so the largest plans read strongest.
  ...
  return (
    <div>
      <PageHeader
        ...
        description="How your recurring revenue splits across plans."
      />
        ...
        report && (
          <div className="flex flex-col gap-6">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              <StatCard label="Total MRR" value={money(total)} hint="Across all plans" />
              <StatCard label="Plans with revenue" value={segments.length.toLocaleString()} hint="Active plans" />
              <StatCard
                label="Top plan"
            ...
            {segments.length === 0 ? (
              <Card className="overflow-hidden">
                <EmptyState
                  ...
                  description="Once you have active subscriptions, the revenue mix by plan appears here."
                />
              </Card>
            ) : (
              <Card className="p-6">
