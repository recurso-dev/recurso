...
//
// We use plain `fetch` here deliberately so the starter stays dependency-free.
// A typed Node SDK is available on npm as `recurso`
// (https://www.npmjs.com/package/recurso) if you prefer typed calls.
